...
tabladirectv2 where id_fecha='$fecha' limit 1";

$resultdirectv2=mysqli_query($conexion,$sql);

$cadena="<label>Base Ingresada:</label>
<input type='hidden' id='directv2' name='directv2'>";

while ($ver=mysqli_fetch_row($resultdirectv2)) {
