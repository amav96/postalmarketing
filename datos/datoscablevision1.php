...
tablacablevision1 where id_fecha='$fecha' limit 1";

$resultcablevision1=mysqli_query($conexion,$sql);

$cadena="<label>Base Ingresada:</label>
<input type='hidden' id='cablevision1' name='cablevision1'>";

while ($ver=mysqli_fetch_row($resultcablevision1)) {
