...
$sql="SELECT id_fecha,fecha_de_ingreso,canal_de_ingreso,administrador FROM tablametrotel1 where id_fecha='$fecha' limit 1";

$resultmetrotel1=mysqli_query($conexion,$sql);

$cadena="<label>Base Ingresada:</label>
<input type='hidden' id='metrotel1' name='metrotel1'>";

while ($ver=mysqli_fetch_row($resultmetrotel1)) {
