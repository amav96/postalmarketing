...
$sql="SELECT id_fecha,fecha_de_ingreso,canal_de_ingreso,administrador FROM tablaintv3 where id_fecha='$fecha' limit 1";

$resultintv3=mysqli_query($conexion,$sql);

$cadena="<label>Base Ingresada:</label>
<input type='hidden' id='intv3' name='intv3'>";

while ($ver=mysqli_fetch_row($resultintv3)) {
