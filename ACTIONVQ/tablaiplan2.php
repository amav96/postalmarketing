...
$sql = "INSERT INTO tablaiplan2 (mes,nro_cliente,cliente,nombre,apellido,email,telefono,rol,fecha_de_ingreso,canal_de_ingreso,administrador,id_fecha) VALUES ('".$campo0."','".$campo1."', '".$campo2."', '".$campo3."', '".$campo4."', '".$campo5."', '".$campo6."', '".$campo7."','".$fecha_de_ingreso."','".$canal_de_ingreso."', '".$administrador."', '".$id_fecha."') ;";                    
